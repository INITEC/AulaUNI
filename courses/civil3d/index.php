      ...
      <div class="main-content">
        <article id="course-142" class="post-142 ib_educator_course type-ib_educator_course status-publish has-post-thumbnail hentry ib-edu-course-single">
          ...
          <div class="course-content entry-content">
            ...
            <div class="course-image"><img width="620" height="384" src="../../iimages/autocad-620x384.jpg" class="attachment-ib-educator-main-column wp-post-image" alt="Online Bookshop" srcset="../../iimages/autocad-620x384.jpg 620w, ../../iimages/autocad-620x384.jpg 1170w" sizes="(min-width: 768px) 620px, 96vw" /></div>
            <h2>Descripción</h2>
            <p>Debido a la aparición de nuevas tecnologías y al despunte de la diagramación en el diseños asistido por computadora ,en la última década,las herramientas computacionales para resolver los problemas de representación se han vuelto irremplazables. Es en este contexto presentamos este primer curso de AUTOCAD BÁSICO APLICADO A LA INGENIERÍA, donde desarrollaremos desde un enfoque práctico las herramientas básicas y su uso a fin de garantizar en los estudiantes de ingeniería y en todos los interesados su correcto aprenddizaje.</p>
          ...
          <section class="ib-edu-lessons">
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 1: <strong id="docs-internal-guid-66c09834-9e64-0b1e-2471-d18139557411">Entorno de trabajo y sistema de coordenadas</strong>.</h1>
              <div class="excerpt">
            
                <ul>
                <li>Iniciando AutoCAD 2014.</li>
<li>Descripción de las partes principales de la pantalla.</li>
<li>Creación de espacios de trabajo.</li>
<li>Administración de Archivos de dibujo *.dwg.</li>
<li>Guardar el archivo de trabajo.</li>
<li>Abrir un archivo existente.</li>
<li>Abrir un nuevo archivo de trabajo.</li>
<li>Ajuste de la rejilla comando GRID.</li>
<li>Límites de visualización comando LIMITS.</li>
<li>Uso del panel de propiedades (Color y grosor de línea).</li>
<li>Mostrar grosores de línea modo LWT.</li>
<li>Dibujo de líneas comando LINE. </li>
<li>Desplazamiento de la vista en el plano de la pantalla comando PAN.</li>
<li>Cambiar la ampliación de un dibujo comando ZOOM.</li>
<li>Selección de objetos Comando SELECT.</li>
<li>Copiar propiedades de objetos comando MATCHPROP.</li>
				</ul>
              </div>
            </article>
            
            <article class="ib-edu-lesson">
              <h1>SEMANA 2: PREFERENCIA A OBJETOS Y DIBUJAR OBJETOS</h1>
              <div class="excerpt">
                <ul>
                <li>Recortar objetos comando TRIM.</li>
<li>Alargar objetos comando EXTEND.</li>  
<li>Dibujar círculos comando CIRCLE.</li> 
<li>Referencia a objetos comando OSNAP.</li>  
<li>Mostrar coordenadas comando ID.</li>  
<li>Medir distancia y ángulo comando DIST.</li>  
<li>Rastreo de referencia a objetos OTRACK.</li>  
<li>Parámetros del comando CIRCLE.</li>  
<li>Dibujar arcos comando ARC.</li>  
<li>Dibujar arandelas comando DONUT.</li>  
<li>Controlar el relleno de los objetos comando FILL.</li>  
<li>Regenerar objetos comando REGEN.</li>  
<li>Dibujar rectángulos comando RECTANG.</li>  
<li>Dibujar polígonos comando POLYGON.</li> 
<li>Dibujar elipses comando ELLIPSE.</li> 
                </ul>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 3: EDICIÓN DE OBJETOS.</h1>
              <div class="excerpt">
              <ul>
                <li>Copiar objetos Comando COPY.</li>  
<li>Mover objetos Comando MOVE.</li>  
<li>Desfase de objetos comando OFFSET.</li>  
<li>Copia simétrica comando MIRROR.</li>  
<li>Redondear y empalmar objetos comando FILLET.</li> 
<li>Aplicar bisel a los objetos comando CHAMFER.</li>  
<li>Cambiar la longitud de los objetos comando LENGTHEN.</li>  
<li>Dividir objetos entre dos puntos comando BREAK.</li>  
<li>Unir objetos comando JOIN.</li>  
<li>Dividir objetos compuestos comando EXPLODE.</li> 
<li>Rotación de objetos comando ROTATE.</li>  
<li>Ampliar o reducir el tamaño de los objetos comando SCALE.</li>  
<li>Estirar objetos comando STRETCH.</li>  
<li>Alineación de objetos comando ALIGN.</li>  
<li>Creación de una matriz de objetos comando ARRAY (Rectangular y Polar).</li>  
<li>Edición de matrices de objetos comando ARRAYEDIT.</li>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 4: SOMBREADOS,TEXTOS, ARREGLOS DE OBJETOS Y CAPAS.</h1>
              <div class="excerpt">
                <ul>
                <li>Aplicar sombreado y relleno a los objetos comando HATCH.</li>  
<li>Editar sombreados o rellenos comando HATCHEDIT.</li>  
<li>Crear objetos de texto en línea múltiple comando MTEXT.</li> 
<li>Crear objetos de texto en una línea comando TEXT.</li> 
<li>Crear estilos de texto comando STYLE.</li>  
<li>Manejador de capas comando LAYER.</li>
<li>Ocultar o bloquear capas comando LAYISO.</li> 
<li>Escala de los tipos de línea comando LTSCALE.</li>  
<li>Establecer grosores de línea actual comando LWEIGHT.</li> 
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 5: ACOTADO Y ESTILO DE DIMENSIONADO.</h1>
              <div class="excerpt">
                <ul>
               <li>Crear estilo de dimensionado comando.</li> 
<li>DIMSTYLE  Ficha líneas.</li>  
<li>Ficha símbolos y flechas.</li> 
<li>Ficha texto.</li>  
<li>Ficha ajustar.</li>  
<li>Ficha unidades principales.</li>  
<li>Ficha unidades alternativas.</li>  
<li>Ficha tolerancias.</li>  
<li>Dimensionamiento Lineal, Alineado, Continuo y de Línea Base.</li>  
<li>Dimensionamiento Angular  Dimensionamiento Radial, Diametral.</li>
<li>Longitud de Arco, Jogged y Directrices  Variables de dimensionado.</li> 
  ...
  <article class="ib-edu-lesson">
              <h1>SEMANA 6: CONFIGURACIÓN DE PÁGINA, PLOTEO Y MANEJO DE ESCALA.</h1>
              <div class="excerpt">
                <ul>
 <li>Administrador de trazadores.</li>
<li>Trazar un dibujo Comando PLOT.</li>  
<li>Crear fichas de presentación comando LAYOUT.</li> 
<li>Crear ventanas graficas comando VPORTS.</li>  
<li>Especificar configuraciones comando PAGESETUP.</li>  
<li>Cambiar la forma ventana gráfica comando VPCLIP.</li> 
<li>Controlar la forma ventana gráfica comando MVIEW.</li> 
