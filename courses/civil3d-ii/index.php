      ...
      <div class="main-content">
        <article id="course-142" class="post-142 ib_educator_course type-ib_educator_course status-publish has-post-thumbnail hentry ib-edu-course-single">
          ...
          <div class="course-content entry-content">
            ...
            <h2>Descripción</h2>
            <p>En la acutualidad resulta ser un instrumento fundamental, para el desarrollo de las obras de construcción, el conocimiento de la tecnología BIM (Building Information Modeling) utilizando software dinámico de modelado de edificios en tres dimensiones y  en tiempo real, para disminuir la pérdida de tiempo y recursos en el diseño y en la ejecución.Así nos complace presentar este curso de REVIT STRUCTURE el cual tiene un aspecto mas práctico a fin de garantizar tanto los conocmientos de diseño estructural y el de diemnsionamiento en 3D.</p>
          ...
          <section class="ib-edu-lessons">
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 1: PRELIMINARES EN EL USO DEL AUTODESK REVIT.</h1>
              <div class="excerpt">
            
                <ul>
          <li>Metodología del curso y presentación de Revit Structure.</li>
<li>Definición de BIM(Modelado de Información de Edificaciones).</li>
<li>Explorando la interfaz de usuario.</li>
<li>Trabajo con elementos estructurales y trabajo con vistas.</li>
<li>Controlando visibilidad de objetos: planos de corte, linework, lineweight.</li>
<li>Vista de elevación y sección.</li>
<li>Trabajo con vistas 3D.</li>
<li>Familias de elementos.</li>
<li>Creando un nuevo proyecto.</li>
<li>Plantillas, sistemas de unidades y escalas.</li>
<li>Creación y modificación de niveles(Plan Type).</li>
<li>Creación y modificación de ejes.</li>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 2: CREACIÓN DE ELEMENTOS ESTRUCTURALES.</h1>
              <div class="excerpt">
                <ul>
               <li>Creación y edición de elementos estructurales: columnas, muros, vigas, sistemas de vigas, losas, planos de cargas en losas, perfiles de acero.</li>

<li>Uso de planos estructurales 2D como punto de partida.
Importación de elementos de otro archivo Revit.</li>
<li>Cimentaciones aisladas.</li>
<li>Cimentaciones corridas.</li>

<li>Escaleras de concreto armado y acero.</li>
<li>Rampas.</li>
                </ul>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 3: REFORZAMIENTO ESTRUCTURAL.</h1>
              <div class="excerpt">
              <ul>
                <li>Reforzamiento manual en zapatas, columnas, placas, muros de concreto, vigas, losas.</li>

<li>Reforzamiento automático usando Revit Extensions.</li>
<li>Etiquetado en modelo de elementos estructurales.</li>
<li>Dimensiones en modelo de elementos estructurales.</li>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 4: CREACIÓN DE VISTAS.</h1>
              <div class="excerpt">
                <ul>
                <li>Creación de vistas de detalle.</li>

<li>Vinculación con detalles de AutoCAD.</li>

<li>Modelado de formas sólidas y formas huecas desarrolladas en sitio (Model in place).</li>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 5: VISUALIZACIÓN,MODIFICACIÓN Y CREACIÓN DE FAMILIAS.</h1>
              <div class="excerpt">
                <ul>
              <li>Hojas y cajetín.</li>
<li>Creación de vistas en planos.</li>
<li>Inserción de detalles.</li>
<li>Leyendas.</li>
<li>Referencias.</li>
<li>Anotaciones y dimensiones adicionales.</li>
