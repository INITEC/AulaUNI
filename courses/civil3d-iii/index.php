...
<link rel="alternate" type="application/rss+xml" title="Educator WP &raquo; Feed" href="../../feed/index.html" />
<link rel="alternate" type="application/rss+xml" title="Educator WP &raquo; Comments Feed" href="../../comments/feed/index.html" />
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="../../wp-includes/wlwmanifest.xml" />
<link rel='next' title='Introduction to Educator' href='../introduction-to-educator-wp/index.html' />
<meta name="generator" content="WordPress 4.1" />
<link rel='canonical' href='../internet-entrepreneurship/index.html' />
    ...
    <div id="page-header-inner">
      <div id="header-container">
        <div class="container clearfix">
          <div id="main-logo"> <a href="../../index.html"> <img src="../../iconos/logo.png" srcset="../../iconos/logo.png 1x, ../../iconos/logo@2x.png 2x" alt=""> </a> </div>
           
          <nav id="main-nav">
            <ul id="menu-main-menu" class="menu"><li id="menu-item-778" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-115 current_page_item menu-item-778"><a href="../../index.html">Inicio</a></li>
                <li id="menu-item-764" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-764"><a href="../index.html">Cursos</a></li>
                <li id="menu-item-764" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-764"><a href="../../about/index.html">Nosotros</a></li>
                <li id="menu-item-764" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-764"><a href="../../contact/index.html">Inscripciones</a></li>
            </ul>						
          </nav> 
    ...
    <div class="container clearfix">
      <div class="main-content">
        <article id="course-142" class="post-142 ib_educator_course type-ib_educator_course status-publish has-post-thumbnail hentry ib-edu-course-single">
          ...
          <div class="course-content entry-content">
            <div class="ib-edu-course-price"> <span class="price"><?php echo $c["costo"];?></span> <a href="../../contact/index.html" class="ib-edu-button">INSCRIPCIÓN</a> </div>
            <div class="course-image"><img width="620" height="384" src="../../iimages/civil3d-iii-620x384.jpg" class="attachment-ib-educator-main-column wp-post-image" alt="Online Bookshop" srcset="../../iimages/civil3d-iii-620x384.jpg 620w, ../../iimages/civil3d-iii-620x384@2x.jpg 1170w" sizes="(min-width: 768px) 620px, 96vw" /></div>
            <h2>Descripción</h2>
            <p>En este último taller se obtienen los criterios y herramientas para asumir el reto de liderar cualquier equipo de diseño en carreteras teniendo como base fundamental el uso de las herramientas que brinda Civil 3D. Además en este taller se hace uso de la Norma Técnica dándole el respaldo legal a cualquier proyecto que se ejecute.</p>
          ...
          <section class="ib-edu-lessons">
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 1: DISEÑO DE PLANTA.</h1>
              <div class="excerpt">
            
                <ul>
 				<li>Orografía del terreno.</li>
                <li>Clasificación según su función.</li>
                <li>Clasificación de acuerdo a la demanda.</li>
                <li>Clasificación según las condiciones Orográficas.</li>
                <li>Velocidad de diseño.</li>
                <li>Trazo de la línea gradiente.</li>
                <li>Elección de calzada y bermas.</li>
                <li>Definir Velocidad directriz según norma.</li>
                <li>Definir Radio mínimo según norma.</li>
                <li>Trazo de alineamiento.</li>
                <li>Verificar condición de Espirales.</li>
                <li>Insertar Espirales de entrada y salida.</li>
                <li>Insertar Sobreancho en curvas Norma Peruana_DG-2013.</li>
                <li>Transición de Peralte Norma Peruana_DG-2013.</li>
				</ul>
              </div>
            </article>
            
            <article class="ib-edu-lesson">
              <h1>SEMANA 2: DISEÑO VERTICAL Y OBRA LINEAL.</h1>
              <div class="excerpt">
                <ul>
 				<li>Creación de Perfil.</li>
                <li>Distancia mínima de parada.</li>
                <li>Distancia mínima de adelanto.</li>
                <li>Diseño Longitud de curva Vertical mínima.</li>
                <li>Diseño de Rasante.</li>
                <li>Creación de Sección típica.</li>
                <li>Corredor, Obra Lineal.</li>
                <li>Creación de superficie de corredor.</li>
                <li>Edición de Corredor.</li>
                <li>Edición de secciones de Corredor.</li>
                <li>Estilo de derrames de talud.</li>
                </ul>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 3: SALIDA DE DATOS </h1>
              <div class="excerpt">
              <ul>
 				<li>Líneas de muestro, superficie y volúmenes.</li>
                <li>Crear secciones.</li>
                <li>Cuadro de movimiento de tierras.</li>
                <li>Tabla de movimiento de tierras.</li>
                <li>Laminado y maquetado de planos.</li>
                <li>Planta y Perfil.</li>
                <li>Secciones.</li>
              </ul>
              </div>
            </article>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 4: PLAN PRODUCTION Y DATA SHOTCUT</h1>
              <div class="excerpt">
                <ul>
                <li>Laminado y maquetado de planos.</li>
                <li>Planta y Perfil.</li>
            ...
            <article class="ib-edu-lesson">
              <h1>SEMANA 5: GLOBAL MAPPER</h1>
              <div class="excerpt">
                <ul>
 				<li>Extracción de curvas de nivel de Google Earth.</li>
				<li>Exportación e importación de objetos de Google Earth.</li>
        ...
        <section class="related-courses">
          ...
          <article class="post-691 ib_educator_course type-ib_educator_course status-publish has-post-thumbnail hentry">
            <div class="post-thumb"><a href="../revit/index.html"><img width="150" height="150" src="../../iimages/revit-150x150.jpg" class="attachment-thumbnail wp-post-image" alt="Dream" srcset="../../iimages/revit-150x150.jpg 150w, ../../iimages/revit-150x150@2x.jpg 300w" sizes="(min-width: 768px) 150px, 96vw" /></a></div>
          ...
          <article class="post-689 ib_educator_course type-ib_educator_course status-publish has-post-thumbnail hentry">
            <div class="post-thumb"><a href="../costos-presupuestos/index.html"><img width="150" height="150" src="../../iimages/costos-150x150.jpg" class="attachment-thumbnail wp-post-image" alt="Diagrams" srcset="../../iimages/costos-150x150.jpg 150w, ../../iimages/costos-150x150@2x.jpg 300w" sizes="(min-width: 768px) 150px, 96vw" /></a></div>
            <div class="post-summary">
      ...
      <div class="page-sidebar" role="complementary">
        <aside id="categories-2" class="widget widget_categories">
          ...
          <ul>
            <li ><a href="../../contact/index.html" style="color:#555">Cuenta bancaria</a></li>
            <li ><a href="../../contact/index.html" style="color:#555">Oficina</a></li>
          </ul>
        </aside>
        <p>&nbsp;</p>
      </div>
                    ...
                    <div class="widgets widgets-1 one-fourth">
                        <aside id="text-3" class="widget widget_text"><h3 class="widget-title">Acerca de Nosotros</h3>			
                            <div class="textwidget"><p>Somos una institución de formación profesional en ...</p>
                                <p><a href="../../about/index.html">Leer más</a></p>
                            </div>
                        </aside>				
                    </div>
    ...
    <div class="container clearfix">
        ...
        <nav id="footer-nav">
            <ul id="menu-footer-menu" class="menu">
                <li id="menu-item-775" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-115 current_page_item menu-item-775"><a href="../../index.html">Inicio</a></li>
                <li id="menu-item-770" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-770"><a href="../index.html">Cursos</a></li>
                <li id="menu-item-776" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-776"><a href="../../about/index.html">Nosotros</a></li>
                <li id="menu-item-788" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-788"><a href="../../contact/index.html">Inscripciones</a></li>
            </ul>			
        </nav>
    </div>
</footer>
