        ...
        <div class="container clearfix">
          ...
          <nav id="main-nav">
            <ul id="menu-main-menu" class="menu">
              ...
              <li id="menu-item-764" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-764"><a href="">Nosotros</a></li>
    ...
    <div class="container clearfix">
      <article id="post-487" class="post-487 page type-page status-publish hentry">
        <div class="entry-content full-width-content">
          <div id="" class="" data-height="300" data-zoom="12" data-latitude="" data-longitude=""></div>
          <div class="dm3-two-third">
            <h3>Nosotros:</h3>
            <p>Aula Uni es una Institución  orientada a la formación y capacitación de personas en las diversas  herramientas de software y nuevas tecnologías. Tenido en cuenta el aspecto  social, somos conscientes de la realidad actual, así como de las múltiples  oportunidades que nos brinda para desarrollarnos en este contexto competitivo.</p>
            <h3>Misión:</h3>
            <p>Formar académicamente a profesionales y estudiantes,  en los principales programas de ingeniería aplicada a la arquitectura,  al diseño y demás disciplinas de carácter tecnológico y científico.</p>
            <h3>Visión:</h3>
            <p>Ser reconocida como la institución líder en educación  en nuestro país, con metodologías educativas innovadoras, a través del uso de las tecnologías de la información y la comunicación (TIC).</p>
            <h3>Valores:</h3>
            <ul>
              <li>Repeto a la persona.</li>
            ...
            <h3>Objetivos:</h3>
            <ul>
              <li>Brindar una educación  de calidad.</li>
              <li>Mejorar nuestra presencia institucional a nivel nacional e internacional.</li>
              <li>Mejorar y fortalecer nuestros proceso.</li>
              <li>Estar a la vanguardia de las innovaciones tecnológicas.</li>
            </ul>
          ...
          <div class="dm3-one-third dm3-column-last">
            ...
            <p><strong>Dirección:</strong><br />
              Universidad Nacional de Ingeniería, pabellón M, 2do piso.<br />
  ...
  <div class="container clearfix">
    ...
    <nav id="footer-nav">
      <ul id="menu-footer-menu" class="menu">
        ...
        <li id="menu-item-776" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-776"><a href="">Nosotros</a></li>
